...
// 	height: '6ft',
// 	age: 24,
// 	var hair = { style: 'spikey', color: 'brown'}
...
var thirdHero = heroes.slice(2, 1)[0];
...
// the current time as a Date object
	function makeChatMessage(message, author) {
		var obj = message + "" + author + "3:00";
		return makeChatMessage(obj);
	}
